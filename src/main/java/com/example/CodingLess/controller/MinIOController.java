package com.example.CodingLess.controller;

import com.example.CodingLess.webapi.ResultObject;
import com.example.CodingLess.util.FileNameUtil;
import io.minio.*;
...
public class MinIOController {
    private static final String bucketName = "tobealuser";
        ...
        try {
            MinioClient minioClient =
                    MinioClient.builder()
                            ...
                            .credentials("minio-user", "minio-pwd")
                            .build();
